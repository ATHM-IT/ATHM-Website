    ...
    return (
        <div style={{
            ...
            <form onSubmit={handleSubmit} style={{
                ...
                <h2 style={{ fontSize: '2rem', marginBottom: '2rem', color: 'white' }}>Create Account</h2>
                ...
                <p style={{ marginTop: '1.5rem', color: 'var(--color-text-muted)' }}>
                    Already have an account? <span style={{ color: 'var(--color-gold)', cursor: 'pointer' }} onClick={() => navigate('/login')}>Login</span>
                </p>
            </form>
        </div>
    );
